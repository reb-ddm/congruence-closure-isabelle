...
\chapter{The CC\_Explain Operation}
...
\begin{tikzpicture}[node distance={16mm}, thick, main/.style = {draw, circle}]
\node[main] (b) {b};
\node[main] (a) [left of=b, node distance=23mm] {a};
\node[main] (c) [below right of=b] {c};
\node[main] (d) [right of=c] {d};

\draw[->] (a) -- node[midway, above, sloped]{\footnotesize $F(a,c) = a$} node[midway, below, sloped]{\footnotesize $F(b,c) = b$} (b);
\draw[->] (c) -- node[midway, above, sloped]{$b = c$} (b);
\end{tikzpicture}
\end{center}
