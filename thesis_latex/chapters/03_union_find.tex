...
\node[main] (u) {$u$};
\node[main] (lv) [below of=u] {$l!v$};
\node[main] (v) [below of=lv, node distance={10mm}] {$v$};
\draw[->] (lv) to [out=135,in=225,looseness=1] node[midway, left]{$p1'$} (u);
\draw[->] (lv) to [out=45,in=315,looseness=1] node[midway, right]{$p2'$} (u);
\draw[->] (v) -- (lv);
\end{tikzpicture}
\end{center}
...
\node[main] (3) [below left of=2] {3};
\draw[->] (3) -- node[midway, above, sloped]{$(3,2)$} (2);
\draw[->] (2) -- node[midway, above, sloped]{$(3,1)$} (0);
...
\node[main] (2) [below left of=0] {2};
\node[main] (3) [below left of=2] {3};
\draw[->] (3) -- node[midway, above, sloped]{1} (2);
\draw[->] (2) -- node[midway, above, sloped]{2} (0);
\draw[->] (1) -- node[midway, above, sloped]{0} (0);
\end{tikzpicture}
\end{center}
