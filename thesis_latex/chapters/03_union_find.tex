...
For the induction step we can show that the parameters of the recursive case  are in the same representative class, therefore we can apply the previous lemma and show that \lstinline|explain| terminates.
\end{proof}
