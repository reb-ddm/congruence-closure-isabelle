...
According to Pierre Corbineau (personal communication, August 29, 2022), there is a research group that is currently looking at congruence closure  in the context of equivalence relations and setoids. The new implementation is based on the paper of Nieuwenhuis et al. \cite{Nieuwenhuis} as in this thesis.
